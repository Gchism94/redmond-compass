...
import type { Guide, GuideContent, GuideItem, GuideSection } from "./types";

const CONTACT_EMAIL = "RedmondCompass@gmail.com";

/**
 * Renderer for the migrated content pages (guides). One component, many pages:
 * the slug comes from the route path, the copy from a lazy content module in the
 * viewer's language. Layout follows the app's design system — cards, one amber
 * CTA per card, 44px taps — not the old site's desktop layout.
 */
