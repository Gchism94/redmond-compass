...
## What's built (BUILD-BRIEF §12, steps 1–6)
...
- Step 7: Owner path (Claim, Dashboard, Edit Listing, Bulletin, Event) — entitlement helper stubbed to Free. "Switch to Business" on Account is the entry point (currently a note).
