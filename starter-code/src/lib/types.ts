...
export interface SpecialHours { date: string; open?: string; close?: string; closed?: boolean; note?: string; }
export interface Hours { week: Record<Weekday, DayHours>; special?: SpecialHours[]; }
