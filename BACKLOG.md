...
| 6 | **Complete and verify directory fields** | Live audit on 2026-08-31: 133 listings; only 1 has a complete structured weekly schedule, while 86 have usable free-text hours. Also, 17 lack an address, 28 lack a phone, 39 lack a website, and 30 lack precise coordinates. The app now shows free-text hours faithfully, labels incomplete schedules as unknown, hides unavailable actions, and never treats fallback coordinates as a real location. | Nothing in the UI, but source completion is required before every card can offer hours, distance, Call, and Directions. |
